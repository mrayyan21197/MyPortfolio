...
export const EXPERIENCES = [
  {
    ...
    description: `Working with clients globally to build modern web applications and dynamic websites. Developed a freelance job portal, blog platforms, and various custom solutions using the MERN stack and Next.js. Focused on delivering high-quality, scalable, and responsive web solutions.`,
    technologies: ["React.js", "Next.js", "Node.js", "MongoDB", "Express.js"],
  },
  {
    year: "Summer 2024",
    role: "Web Developer Intern",
    company: "Saptatechnologies",
    description: `Developed a Virtual Art Gallery management system using .NET Core, Angular, Bootstrap, and SQL Server. Collaborated with senior developers to design backend APIs and create intuitive, responsive user interfaces for a seamless art exhibition experience.`,
    technologies: ["MongoDB", "Express.js", "React.js", "Node.js", "Axios"],
  },
  {
    year: "Summer 2023",
    role: "Web Development Intern",
    company: "Synergy Pvt Ltd",
    description: `Worked on developing a real-time weather application using the MERN stack. Implemented REST APIs, dynamic UI components, and integrated external weather APIs to fetch and display live weather data for multiple cities.`,
  ...
  },
  {
    ...
    description: `Designed and built an Airport Management System with JavaFX for frontend and Java with MySQL backend. Focused on booking management, flight schedules, and administration features while ensuring robust database connectivity and user-friendly design.`,
...
export const PROJECTS = [
  {
    ...
    image: project1,
    description:
      "A full-featured freelance marketplace platform similar to Fiverr, allowing freelancers to create gigs and clients to place orders, with integrated real-time chat, authentication, and admin dashboards.",
  ...
  },
  {
    ...
    technologies: ["MongoDB", "Next.js", "Node.js", "Express.js"],
  },
  {
    ...
    technologies: ["Python", "TensorFlow", "OpenAI Gym", "TORCS"],
  },
  {
  ...
  },
  {
    ...
    technologies: [".NET Core", "Angular", "Bootstrap", "SQL Server"],
  },
  {
    title: "Weather App",
    image: project7,
